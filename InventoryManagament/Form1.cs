...
namespace BaskanTicaret
{
    public partial class Form1 : Form
    {
        ...
        private void AdjustForm()
        {
            switch (this.WindowState)
            {
                case FormWindowState.Maximized:
                    this.Padding = new Padding(0, 8, 8, 0); break;
        ...
        public void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.formpanelDesktoppanel.Controls.Add(childForm);
            this.formpanelDesktoppanel.Tag = childForm;
        ...
        {
            OpenChildForm(new Forms.Preview(), sender);
        }
        ...
        {
            OpenChildForm(new Forms.Management(), sender);
        }
